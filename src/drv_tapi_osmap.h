...
#include "os_calls/ifxos_debug.h" /* debug features */
...
#include "os_calls/ifx_fifo.h"  /* fifo (used for streaming) */
...
/*
   Mapping table - FIFO
*/
#define TAPI_OS_FifoInit                  IFX_Fifo_Init
#define TAPI_OS_FifoClear                 IFX_Fifo_Clear
#define TAPI_OS_FifoIsEmpty               IFX_Fifo_isEmpty
#define TAPI_OS_FifoReadElement           IFX_Fifo_readElement
#define TAPI_OS_FifoWriteElement          IFX_Fifo_writeElement
#else
/*
   Mapping table - Time and Waiting.
*/
...
/*
   Mapping table - FIFO
*/
#define TAPI_OS_FifoInit                  LINUX_Fifo_Init
#define TAPI_OS_FifoClear                 LINUX_Fifo_Clear
#define TAPI_OS_FifoIsEmpty               LINUX_Fifo_isEmpty
#define TAPI_OS_FifoReadElement           LINUX_Fifo_readElement
#define TAPI_OS_FifoWriteElement          LINUX_Fifo_writeElement
#endif /* IFXOS_ENABLED */
/*
