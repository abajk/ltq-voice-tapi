...
struct IFX_TAPI_EVENT_INFORMATION_BITS
{
   ...
   IFX_uint32_t sysclk_down_forced_end:1;
};
   ...
   do
   {
      switch(pEvent->id)
      {
         ...
         case IFX_TAPI_EVENT_INFO_SYSCLK_DOWN_FORCED:
            ...
            bExitLoop = IFX_TRUE;
            break;
         case IFX_TAPI_EVENT_INFO_SYSCLK_DOWN_FORCED_END:
            pEventMask->information.sysclk_down_forced_end = value;
            bExitLoop = IFX_TRUE;
            break;
...
IFX_int32_t IFX_TAPI_Event_Dispatch_ProcessCtx(IFX_TAPI_EXT_EVENT_PARAM_t *pParam)
{
   ...
   else
   {
      ...
      case IFX_TAPI_EVENT_INFO_SYSCLK_DOWN_FORCED_END:
         bEventDisabled = pEventMask->information.sysclk_down_forced_end ?
                         IFX_TRUE : IFX_FALSE;
         break;
