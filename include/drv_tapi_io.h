...
typedef enum
{
   ...
   /** LEC window size 12 ms. */
   IFX_TAPI_WLEN_WSIZE_12 = 12,
   /** LEC window size 16 ms. */
   IFX_TAPI_WLEN_WSIZE_16 = 16,
   /** LEC window size 24 ms. */
   IFX_TAPI_WLEN_WSIZE_24 = 24
...
/** Min jitter buffer scaling factor value (16) */
#define IFX_TAPI_JB_SCALING_MIN 0x10

/** Max jitter buffer scaling factor value (255) */
#define IFX_TAPI_JB_SCALING_MAX 0xFF

/** Max jitter buffer size in 125 us units
   (0xC80 = 400ms / 125us) */
#define IFX_TAPI_JB_SIZE_MAX 0xC80
...
/** Default rating factor max value */
#define IFX_TAPI_DEFAULT_RATING_FACTOR_MAX 127
/** Calculation Time Interval max value */
#define IFX_TAPI_CALCULATION_TIME_INTERVAL_MAX 124
/** Advantage Factor max value */
#define IFX_TAPI_ADVANTAGE_FACTOR_MAX 127
/** MOS min value */
#define IFX_TAPI_MOS_MIN 100
/** MOS max value */
#define IFX_TAPI_MOS_MAX 450
...
/** Maximum number of packets to calculate FEC */
#define IFX_TAPI_T38_PKT_FEC_MAX 6
/** Maximum data wait time value in msec */
#define IFX_TAPI_T38_DWT_MAX 1000
/** Minimum time-out for start of T.38 modulation (in ms) */
#define IFX_TAPI_T38_MOD_AUTOSTART_TIME_MIN 2000
/** Maximum time-out for start of T.38 modulation (in ms) */
#define IFX_TAPI_T38_MOD_AUTOSTART_TIME_MAX 2600
/** Minimum time to insert spoofing during automatic modulation */
#define IFX_TAPI_T38_SPOOF_AUTO_INSERT_TIME_MIN 10
/** Maximum time to insert spoofing during automatic modulation */
#define IFX_TAPI_T38_SPOOF_AUTO_INSERT_TIME_MAX 4100
/** Maximum desired output power level */
#define IFX_TAPI_T38_POWER_LEVEL_MAX 63
/** Maximum number of additional recovery data
    packets sent on high-speed fax transmissions */
#define IFX_TAPI_T38_PKT_RECOV_HI_SPEED_MAX 4
/** Maximum number of additional recovery data
    packets sent on low-speed fax transmissions */
#define IFX_TAPI_T38_PKT_RECOV_LO_SPEED_MAX 4
/** Maximum number of additional recovery T30_INDICATOR packets */
#define IFX_TAPI_T38_PKT_RECOV_INDICATOR_MAX 4
...
typedef struct
{
   ...
   /** Data wait time (in ms); time to buffer T.30 data before start of
       ...
       Range:
       - Minimum: 0 ms
       - Maximum: \ref IFX_TAPI_T38_DWT_MAX ms */
   IFX_uint16_t                  nDWT;
   /** Time-out for start of T.38 modulation (in ms).
       Range:
       - Minimum: \ref IFX_TAPI_T38_MOD_AUTOSTART_TIME_MIN ms
       - Maximum: \ref IFX_TAPI_T38_MOD_AUTOSTART_TIME_MAX ms
   ...
   /** Time to insert spoofing during automatic modulation (in ms).
       ...
       Range:
       - Minimum: \ref IFX_TAPI_T38_SPOOF_AUTO_INSERT_TIME_MIN ms
       - Maximum: \ref IFX_TAPI_T38_SPOOF_AUTO_INSERT_TIME_MAX ms
       Only applicable in case the bit IFX_TAPI_T38_FEAT_LONG is set in
       'OptionMask'. */
...
/** Demodulation buffer level min value */
#define IFX_TAPI_DEMODULATION_BUFFER_LEVEL_MIN 1
/** Demodulation buffer level max value */
#define IFX_TAPI_DEMODULATION_BUFFER_LEVEL_MAX 144
...
typedef struct
{
   ...
   /** Required demodulation buffer level (in units of 0.625 ms)
       ...
       least 'nDmbsd'.
       Range:
       - Minimum: \ref IFX_TAPI_DEMODULATION_BUFFER_LEVEL_MIN (0.625 ms)
       - Maximum: \ref IFX_TAPI_DEMODULATION_BUFFER_LEVEL_MAX (90 ms) */
   IFX_uint16_t                  nDmbsd;
...
/** The highest standard available for fax T.38 */
#define IFX_TAPI_T38_STANDARD_MAX 0x0B
...
typedef enum
{
   ...
   /** Notification that after a forced clock down the system clock has
       returned to the requested clock speed. */
   IFX_TAPI_EVENT_INFO_SYSCLK_DOWN_FORCED_END = IFX_TAPI_EVENT_TYPE_INFO | 0x0003,
